...
#define OV32D40_REG_VTOTAL		CCI_REG16(0x380E)
//#define OV32D40_REG_VTOTAL_HIGH	CCI_REG8(0x3840)
#define OV32D40_VTOTAL_MAX		0xffff
	...
	if (fmt->which == V4L2_SUBDEV_FORMAT_TRY)
		*v4l2_subdev_state_get_format(sd_state, 0) = fmt->format;
		...
		__v4l2_ctrl_modify_range(ov32d40->vblank, vblank_def,
					 OV32D40_VTOTAL_MAX - mode->height, 1,
					 vblank_def);
		__v4l2_ctrl_s_ctrl(ov32d40->vblank, vblank_def);

		h_blank = mode->hts_def - mode->width;
		__v4l2_ctrl_modify_range(ov32d40->hblank, h_blank, h_blank, 1,
					 h_blank);
	}
...
static int ov32d40_set_ctrl(struct v4l2_ctrl *ctrl)
{
	...
	case V4L2_CID_VBLANK:
		ret = cci_write(ov32d40->regmap, OV32D40_REG_VTOTAL,
...
static int ov32d40_initialize_controls(struct ov32d40 *ov32d40)
{
	...
	ov32d40->vblank = v4l2_ctrl_new_std(handler, &ov32d40_ctrl_ops, V4L2_CID_VBLANK, vblank_def,
			  		    OV32D40_VTOTAL_MAX - mode->height, 1, vblank_def);

	exposure_max = mode->vts_def - OV32D40_EXPOSURE_MAX_MARGIN;
...
static int ov32d40_probe(struct i2c_client *client)
{
	...
	ret = v4l2_async_register_subdev(&ov32d40->subdev);
	if (ret) {
